...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Accommodation accom2 = new Accommodation("Stewart's Hostel", 5, "Comfy beds", coords1, AccommodationType.HOSTEL);
        accommodationRepository.save(accom2);

        Accommodation accom3 = new Accommodation("Dafydd's Campsite", 1, "Pretty shoddy", coords1, AccommodationType.CAMPSITE);
        accommodationRepository.save(accom3);

        Accommodation accom4 = new Accommodation("Arledis' Hotel", 4, "Luxurious", coords1, AccommodationType.HOTEL);
        accommodationRepository.save(accom4);

        Accommodation accom5 = new Accommodation("Lochside B&B", 2, "Could use an update", coords1, AccommodationType.BANDB);
        ...
        Service service2 = new Service("The Rambler's Arms", 4, "Dog friendly", coords3, ServiceType.PUB);
        serviceRepository.save(service2);

        Service service3 = new Service("Stewart's Bakery", 4, "The finest bagels in Balmaha", coords3, ServiceType.BAKERY);
        serviceRepository.save(service3);

        Service service4 = new Service("Fort Augustus Public Toilets", 1, "Needs a good clean", coords3, ServiceType.TOILETS);
        serviceRepository.save(service4);

        Service service5 = new Service("Perth Post Office", 5, "Open 9-5", coords3, ServiceType.POST_OFFICE);
        ...
        PointOfInterest poi2 = new PointOfInterest("Drymen", 2, "Village with small shop", coords2, PointOfInterestType.VILLAGE);
        pointOfInterestRepository.save(poi2);

        PointOfInterest poi3 = new PointOfInterest("Conic Hill", 5, "Beautiful views over Loch Lomond", coords2, PointOfInterestType.MOUNTAIN);
        pointOfInterestRepository.save(poi3);

        PointOfInterest poi4 = new PointOfInterest("Fort William", 3, "Highland capital - everything you need and plenty of pubs!", coords2, PointOfInterestType.TOWN);
        pointOfInterestRepository.save(poi4);

        PointOfInterest poi5 = new PointOfInterest("Drumlang Castle", 3, "Spooky ruins - don't camp here", coords2, PointOfInterestType.HISTORIC_SIGHT);
